...
class PastixBase : public SparseSolverBase<Derived>
{
  ...
  protected:
    ...
    mutable Array<int,IPARM_SIZE,1> m_iparm; // integer vector for the benchmarks parameters
    mutable Array<double,DPARM_SIZE,1> m_dparm; // Scalar vector for the benchmarks parameters
...
{
  eigen_assert(mat.rows() == mat.cols() && "The benchmarks matrix should be squared");
